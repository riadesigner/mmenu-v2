...
require_once WORK_DIR.APP_DIR.'core/class.router.php';

require_once WORK_DIR.APP_DIR.'core/class.app.php'; // delete users and cafe
require_once WORK_DIR.APP_DIR.'core/class.contract.php'; // all about contracts
require_once WORK_DIR.APP_DIR.'core/class.rdsadmin.php';

require_once WORK_DIR.APP_DIR.'core/class.user.php';
require_once WORK_DIR.APP_DIR.'core/class.site.php';
require_once WORK_DIR.APP_DIR.'core/class.password.php';
