...
// PBL CART.get_all() is a map keyed by uniq_name; from-cart expects a list
if (is_array($order_data) && isset($order_data['order_items']) && is_array($order_data['order_items'])) {
	$order_data['order_items'] = array_values($order_data['order_items']);
}
