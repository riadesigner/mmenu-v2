	...
	init:function(lang){
		...
		this.LANG_DATA = {
			...
			lng_view_change_subdomain__text4:[
				'-',
				[
					'<p >Соблюдайте простые условия:</p><p style="font-size:.8rem;">',
			...
			lng_view_change_subdomain__text6:[
				'-',
				'У вашего меню есть также постоянный «технический» адрес, полученный при регистрации:'
			],
			...
			lng_view_cafe_link__qrcode:[
				'-',
				'Получите на почту и распечатайте этот QR-код вашего меню.'
			],
