...
define('IIKO_MODE', true); // always iiko external menu

// ----------------------------------------
// CHATS_APP path: prefer from-cart (build in chats)
// ----------------------------------------
if(PENDING_MODE === 2){
	...
	// Cafe not re-exported yet — fall back to local FULL_ORDER + POST /orders
...
// ----------------------------------------
// Build FULL_ORDER locally (TG path, or chats fallback)
// ----------------------------------------
...
if(PENDING_MODE !==2){
	...
	// ----------------------------------------
	// TG path (legacy, until last cafe migrates)
	// ----------------------------------------
	...
	// ----------------------------------------
	// Fallback: local FULL_ORDER → POST /api-internal/orders
	// ----------------------------------------
...
/**
 * Prefer chats-app build+create. Returns { ok, data } or { ok:false, errorCode, message, httpCode }.
 */
