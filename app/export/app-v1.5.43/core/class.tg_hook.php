...
class Tg_hook {
    ...
    public function parse(): void{
        ...
        if($this->REAL_TG_USER){            
            ...
            if($this->CALLBACK_MODE){
                ...
                // if($this->check_if_wait_comment_to_order()){
    ...
    private function check_if_wait_comment_to_order(): bool{
        return $this->REAL_TG_USER->typing_comment_now===1;
    }        

    private function close_comment_to_order(): void{
        // - добавляем коммент к последнему заказу, 
        // который взял данный официант (менеджер)
        // ....  TODO xxx
        // - сбрасываем ожидание коммента от данного официанта
        $this->REAL_TG_USER->typing_comment_now = 0;
