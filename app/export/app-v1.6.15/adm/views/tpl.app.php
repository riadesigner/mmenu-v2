		...
		<div class="app-view-page">		
			<div class="app-view-page-container overflow-y">
				<div class="std-form">
					...
					<div>
						<p>Внешний URL (без https://):</p>
						<div class="std-form__long_bright_word view-change-subdomain__external-url-preview">Не указан</div>
						<input class="std-form__input" type="input" 
						placeholder="you-address.ru" name="external-url" maxlength="50" >
					</div>
		...
		<div class="app-view-page">		
			<div class="app-view-page-container overflow-y">
				<div class="std-form">
					...
					<button class="std-special-single-button btn-iiko-terminal-wake-up">Разбудить</button>
...
<!-- - - - - - - - VIEW UPDATING IIKO WEB HOOK - - - - - - - -  -->
	...
	<div class="app-view view-iiko-web-hooks">
		...
		<div class="app-view-page">
			<div class="app-view-page-container overflow-y">
				<div class="std-form">
					<div class="iiko-api-login-name"><p>Login: <strong><span></span></strong></p></div>					
					<div class="std-form__bright-link iiko-web-hook_preview"></div>
					<br />
					<div class="std-form__section-description" >Введите новый адрес iiko web hook</div>
					<input class="std-form__input" name="new-iiko-web-hook" type="text" maxlength="100" placeholder="">
			...
			<div class="app-view-page-container overflow-y">
				<div class="std-form">
					...
					<div class="iiko-mode-only">
						...
						<p>Заказ на стол отправляется всем официантам в общий Telegram канал.</p>
						<p>После того, как любой из официантов возьмет заказ, остальным отправляется уведомление, что заказ в работе, а посетителю отправляется сообщение, что заказ принят.</p>
						<p>При выборе второго варианта, у официанта будет возможность перенаправить заказ дальше – на кассу (в iiko front).</p>
			...
			<div class="app-view-page-container overflow-y">
				<div class="std-form">
					...
					<div class="super-admin-only">						
						...
						<hr />
						<p>Если нужно обновить данные iiko в чате официантов, чтобы отправлять заказы на кассу:</p>
						<button name="export_iiko_to_chats_app">Экспорт iiko параметров</button>						

						<hr />
						<p>Если нужно обновить общие данные кафе в чате официантов (название кафе, ссылка на меню) </p>
						<button name="export_cafe_data_to_chats_app">Экспорт общих параметров</button>						
...
<!-- - - - - - - - VIEW CAFE LINK - - - - - - - - - - - - - -->
	...
	<div class="app-view view-cafe-link">
		...
		<div class="app-view-page">
			<div class="app-view-page-container overflow-y">				
				<div class="std-form">
					<div class="std-form__section-description">Адреса вашего меню:</div>
						<div class="std-form__bright-link menu-home-links"><!-- all links --></div>	
		...
		<div class="item">
			...
			<div class="item__front-layer">				
				<div class="small-item-image">							
					<div class="small-item-image__holder hidden">
						<div><small>Внешняя<br>картинка</small></div>
					</div>
