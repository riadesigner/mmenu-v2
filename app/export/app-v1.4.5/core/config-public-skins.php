...
$CFG->public_skins = [
    ...
    'all-skins'=>[
        [
            ...
            'group'=>'dark', 
            'params'=>[
                'color-menu-around-from' => '#342118',
                'color-menu-around-to' => '#2c1b12ff',
                'color-bg' => '#180e09',
                'color-front'=>'#ffffff',
                ...
                'color-options-arrow'=>'#232527',
                'border-style-1'=>'1px solid #432e28',
                'border-style-2'=>'2px dotted #432e28',
                'border-style-3'=>'1px solid #432e28',
                'fields-border-default'=>'border: 2px solid #432e28',
                ...
                'btn-addtocart-hover'=>'color: #ffffff;border:2px solid #E8833C;background: #432e28',
                ...
                // default buttons
                'regular-btn-default'=>'color: #ffffff; background: transparent',
                'regular-btn-hover'=>'border:2px solid #432e28 ',
                'regular-btn-active'=>'border:2px solid #ffffff; background: #432e28',
                'regular-btn-mobile-active'=>'background: #432e28',
                // footer buttons
                'footer-btn-default'=>'color: #E8833C; background:transparent',
                'footer-btn-disabled'=>'',
                'footer-btn-hover'=>'border:2px solid #432e28',
                'footer-btn-active'=>'border:2px solid #ffffff; background: #432e28',
                'footer-btn-mobile-active'=>'background: #432e28',
                ...
                'footer-inform-color'=>'#432e28',
                'footer-background-color'=>'#180e09',
                'footer-mobile'=>'border-top:1px solid #432e28',
                'footer-decoration'=>'border-top: 1px solid #432e28',
                'footer-decoration-mobile'=>'border-top: 1px solid #ffffff',
